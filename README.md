# dhcp
[![Build Status](https://img.shields.io/github/actions/workflow/status/hartzenberg/dhcp/tests.yml?branch=master)](https://github.com/hartzenberg/dhcp/actions?query=branch%3Amaster)
[![GoDoc](https://godoc.org/github.com/hartzenberg/dhcp?status.svg)](https://godoc.org/github.com/hartzenberg/dhcp)
[![codecov](https://codecov.io/gh/hartzenberg/dhcp/branch/master/graph/badge.svg)](https://codecov.io/gh/hartzenberg/dhcp)
[![Go Report Card](https://goreportcard.com/badge/github.com/hartzenberg/dhcp)](https://goreportcard.com/report/github.com/hartzenberg/dhcp)
...
```
go get -u github.com/hartzenberg/dhcp/dhcpv{4,6}
```
...
See more example code at https://github.com/hartzenberg/exdhcp
